...
{
    public partial class FrmDatosPrimerOrdenProporcionalIntegral : Form
    {
        RootLocus rl;
        PointPairList polos;
        PointPairList ceros;
        ...
        public FrmDatosPrimerOrdenProporcionalIntegral(PointPairList polos, PointPairList ceros, RootLocus rl,string polo1,string polo2,string cero1)
        {
            InitializeComponent();
            this.rl = rl;
            this.polos = polos;
        ...
        private void FrmDatosPrimerOrdenProporcionalIntegral_Load(object sender, EventArgs e)
        {
        ...
        private bool validoReglas()
        {
            ...
            if (ftbxPol2.Text.Equals("0") || ftbxCer1.Text.Equals("0"))
            {
            ...
            if (ftbxCer1.Text.Equals("") || ftbxPol2.Text.Equals(""))
            {
        ...
        private void inicializarControles()
        {
            ...
            {
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaPI;
                ftbxCer1.Visible = true;
                ftbxCer2.Visible = false;
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    if (ftbxPol1.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd1.Location = new Point(posCtrl + 44, lblDenProd1.Location.Y);
