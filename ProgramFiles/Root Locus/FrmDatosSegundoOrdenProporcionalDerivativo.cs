...
{
    public partial class FrmDatosSegundoOrdenProporcionalDerivativo : Form
    {
        RootLocus rl;
        PointPairList polos;
        PointPairList ceros;
        ...
        private void FrmDatosSegundoOrdenProporcionalDerivativo_Load(object sender, EventArgs e)
        {
        ...
        private bool validoReglas()
        {
            ...
            if (ftbxPol1.Text.Equals("0") || ftbxCer1.Text.Equals("0") || ftbxPol2.Text.Equals("0"))
            {
            ...
            if (ftbxCer1.Text.Equals("") || ftbxPol1.Text.Equals("") || ftbxPol2.Text.Equals(""))
            {
        ...
        private void inicializarControles()
        {
            ...
            {
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaPD2;
                ftbxCer1.Visible = true;
