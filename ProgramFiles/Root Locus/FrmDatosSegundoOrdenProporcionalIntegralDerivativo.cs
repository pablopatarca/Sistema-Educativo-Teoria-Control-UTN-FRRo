...
{
    public partial class FrmDatosSegundoOrdenProporcionalIntegralDerivativo : Form
    {
        RootLocus rl;
        PointPairList polos;
        PointPairList ceros;
        ...
        private void FrmDatosSegundoOrdenProporcionalIntegralDerivativo_Load(object sender, EventArgs e)
        {
        ...
        private void btnEj4_Click(object sender, EventArgs e)
        {
            ...
            //ftbK.Text = "120,00";
            //ftbPtos.Text = "380";
            pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaPIDImaginario2;
        ...
        private bool validoReglas()
        {
            ...
            if (ftbxCer1.Text.Equals("0") || ftbxCer2.Text.Equals("0") || ftbxPol2.Text.Equals("0") || ftbxPol3.Text.Equals("0"))
            {
            ...
            if (rbRe.Checked)
            {
                if (ftbxCer1.Text.Equals("") || ftbxCer2.Text.Equals("") || ftbxPol2.Text.Equals("") || ftbxPol3.Text.Equals(""))
                {
            ...
            {
                if (ftbImgAux1.Text.Equals("") || ftbImgAux2.Text.Equals("") || ftbRAux1.Text.Equals("") || ftbRAux2.Text.Equals("") || ftbxPol2.Text.Equals("") || ftbxPol3.Text.Equals(""))
                {
                    resp += "-Debe ingresar todos los campos.\n";
                    valido = false;
                }
        ...
        private void inicializarControles()
        {
            ...
            {
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaPID2;
                ftbxCer1.Visible = true;
                ftbxCer2.Visible = true;
            ...
            ftbxPol1.Visible = true;
            ftbxPol2.Visible = true;
            if (ftbxPol1.Text == "") ftbxPol2.Enabled = true;
            else ftbxPol2.Enabled = true;
            ftbxPol3.Visible = true;
            if (ftbxPol2.Text == "") ftbxPol3.Enabled = true;
