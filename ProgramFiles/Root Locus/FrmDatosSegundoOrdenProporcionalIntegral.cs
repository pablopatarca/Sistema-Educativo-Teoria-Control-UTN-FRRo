...
{
    public partial class FrmDatosSegundoOrdenProporcionalIntegral : Form
    {
        RootLocus rl;
        PointPairList polos;
        PointPairList ceros;
        ...
        public FrmDatosSegundoOrdenProporcionalIntegral(PointPairList polos, PointPairList ceros, RootLocus rl,string polo1,string polo2,string polo3,string cero1)
        {
            InitializeComponent();
            this.rl = rl;
            this.polos = polos;
        ...
        private void FrmDatosSegundoOrdenProporcionalIntegral_Load(object sender, EventArgs e)
        {
        ...
        private bool validoReglas()
        {
            ...
            if (ftbxCer1.Text.Equals("0") || ftbxPol2.Text.Equals("0") || ftbxPol3.Text.Equals("0"))
            {
            ...
            if (ftbxCer1.Text.Equals("") || ftbxPol1.Text.Equals("") || ftbxPol2.Text.Equals("") || ftbxPol3.Text.Equals(""))
            {
        ...
        private void inicializarControles()
        {
            ...
            {
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaPI2;
                ftbxCer1.Visible = true;
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    if (ftbxPol1.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd1.Location = new Point(posCtrl + 42, lblDenProd1.Location.Y);
                    ...
                    if (ftbxPol3.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd3.Location = new Point(posCtrl + 45, lblDenProd3.Location.Y);
