...
{
    public partial class FrmDatosPrimerOrdenProporcionalIntegralDerivativo : Form
    {
        RootLocus rl;
        PointPairList polos;
        PointPairList ceros;
        ...
        public FrmDatosPrimerOrdenProporcionalIntegralDerivativo(PointPairList polos, PointPairList ceros, RootLocus rl,string polo1, string polo2,string cero1, string cero2, string realOImaginario)
        {
            InitializeComponent();
            this.rl = rl;
            this.polos = polos;
        ...
        private void FrmDatosPrimerOrdenProporcionalIntegralDerivativo_Load(object sender, EventArgs e)
        {
        ...
        private void reset()
        {
            ...
            {
                ftbP.Text = "";
                ftbP.Visible = false; //Pongo en falso para que no me habilite todos los textbox, defino abajo los que quiero que aparezcan
            }
            ...
            ftbxPol1.Enabled = false;
            ftbxPol1.Text = "0";
            ftbxPol2.Visible = true;
            ftbxPol2.Enabled = true;
            ftbxCer1.Visible = true;
            ftbxCer1.Enabled = true;
            ftbxCer2.Visible = true;
        ...
        private bool validoReglas()
        {
            ...
            if (ftbxPol2.Text.Equals("0") || ftbxCer1.Text.Equals("0") || ftbxCer2.Text.Equals("0"))
            {
                resp += "-El valor ingresado debe ser distino de cero.\n";

                if (ftbxPol2.Text.Equals("0"))
                {
                    ftbxPol2.Text = "";
                }
            ...
            if (rbRe.Checked)
            {
                if (ftbxCer1.Text.Equals("") || ftbxCer2.Text.Equals("") || ftbxPol2.Text.Equals(""))
                {
            ...
            {
                if (ftbImgAux1.Text.Equals("") || ftbImgAux2.Text.Equals("") || ftbRAux1.Text.Equals("") || ftbRAux2.Text.Equals("") || ftbxPol2.Text.Equals(""))
                {
                    resp += "-Debe ingresar todos los campos.\n";
                    valido = false;
                }
        ...
        private void inicializarControles()
        {
            ...
            if (rbIm.Checked)
            {
                ...
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaPIDImaginaria;
            }
            else
            {
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaPID;
                ftbxCer1.Visible = true;
                ftbxCer2.Visible = true;
                //para controlar las habilitaciones de las cajas de texto según el estado del anterior
                if (ftbxCer1.Text == "") ftbxCer2.Enabled = true;
                else ftbxCer2.Enabled = true;
            }
            ftbxPol1.Visible = true;
            ftbxPol2.Visible = true;
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    if (rbRe.Checked) //ceros reales
                    {
                        ...
                        if (ftbxCer2.Text != "")
                        {
                            ...
                            else if ((i == 1) && (permitir))
                            {
                                ...
                                lblNumProd3.Location = new Point(posCtrl + 45, lblNumProd3.Location.Y);
                    ...
                    else //ceros imaginarios
                    {
                        if (ftbxCeroIm.Text != "")
                        {
                            ...
                            else
                            {
                                ...
                                lblNumComReal1.Location = new Point(posCtrl + 45, lblNumComReal1.Location.Y);
                    ...
                    if (ftbxPol1.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd1.Location = new Point(posCtrl + 38, lblDenProd1.Location.Y);
                    ...
                    if (ftbxPol2.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd2.Location = new Point(posCtrl + 47, lblDenProd2.Location.Y);
                    ...
                    if (ftbxPol3.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd3.Location = new Point(posCtrl + 47, lblDenProd3.Location.Y);
                    ...
                    if (ftbxPol4.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd4.Location = new Point(posCtrl + 47, lblDenProd4.Location.Y);
        ...
        private void ftbxCer1_Text_Changed(object sender, EventArgs e)
        {
            //if (ftbxCer1.Text.Equals("0"))
            //{
            //    MessageBox.Show("El valor ingresado debe ser distino de cero", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //    ftbxCer1.Text = "";
            //}
            //if (ftbxCer1.Text != "")
            //    ftbxCer2.Enabled = true;
        ...
        private void ftbxCer2_Text_Changed(object sender, EventArgs e)
        {
            //if (ftbxCer2.Text.Equals("0"))
            //{
            //    MessageBox.Show("El valor ingresado debe ser distino de cero", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
