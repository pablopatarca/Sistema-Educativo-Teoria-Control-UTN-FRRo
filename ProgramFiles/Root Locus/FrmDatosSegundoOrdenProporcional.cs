...
{
    public partial class FrmDatosSegundoOrdenProporcional : Form
    {
        RootLocus rl;
        PointPairList polos;
        PointPairList ceros;
        ...
        public FrmDatosSegundoOrdenProporcional(PointPairList polos, PointPairList ceros, RootLocus rl,string polo1, string polo2)
        {
            InitializeComponent();
            this.rl = rl;
            this.polos = polos;
        ...
        private void FrmDatosSegundoOrdenProporcional_Load(object sender, EventArgs e)
        {
        ...
        private void reset()
        {
            ...
            //para que solo sea visible el textbox del primer y segundo polo
        ...
        private bool validoReglas()
        {
            ...
            if (ftbxPol1.Text.Equals("0") || ftbxPol2.Text.Equals("0"))
            {
            ...
            if (ftbxPol1.Text.Equals("") || ftbxPol2.Text.Equals(""))
            {
            ...
            if (cantPol < 2)          
            {    
                resp += "-Debe ingresar ambos polo para poder continuar.\n";   
                valido = false;
            }
            if (cerosDominantes)
            {
        ...
        private void inicializarControles()
        {
            ...
            {
                pbFuncTranf.Image = Root_Locus.Properties.Resources.ProporcionalSegundoOrden;
