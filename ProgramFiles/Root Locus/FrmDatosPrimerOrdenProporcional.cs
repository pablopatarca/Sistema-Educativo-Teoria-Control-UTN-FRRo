...
{
    public partial class FrmDatosPrimerOrdenProporcional : Form
    {
        RootLocus rl;
        PointPairList polos;
        PointPairList ceros;
        ...
        private void FrmDatosPrimerOrdenProporcional_Load(object sender, EventArgs e)
        {
            ...
            //Lo comentamos para que nos permita ingresar los valores a los textbox y no los limpie luego de haberlos ingresado
            //reset();
        }
        ...
        private void reset()
        {
            ...
            //hacemos invisibles todos los textbox de los polos
            ...
            //para que solo sea visible el textbox del primer polo
        ...
        private bool validoReglas()
        {
            ...
            if (cantPol < 1)          
            {    
                resp += "-Debe ingresar el polo para poder continuar.\n";   
                valido = false;
            }
            if (cerosDominantes)
            {
        ...
        private void inicializarControles()
        {
            ...
            {
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaProporcional;
            ...
            //Este es el textbox que necesitamos mantener habilitado para el ingreso de datos en controlador proporcional primer orden
            ftbxPol1.Visible = true;

            //Los siguientes textbox no son necesarios para el proporcional primer orden, por lo que se los hace invisibles para que no sea posible ingresar valores
        ...
        {
            this.metodoBtnIngresar_Click();
            this.Dispose();
        }

        private void metodoBtnIngresar_Click()
        {
        ...
        private void radioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rb == rbRe)
            {
                ...
                pbFuncTranf.Image = Root_Locus.Properties.Resources.formulaFuncionTransferencia_4;
            }
            else
            {
                ftbxCeroRe.Visible = true;
        ...
        private void chkVistaPrevia_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (chkVistaPrevia.Checked) //vista previa
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    if (rbRe.Checked) //ceros reales
                    {
                        ...
                        if (ftbxCer1.Text != "")
                        {
                            ...
                            else if ((i == 1) && (permitir))
                            {
                                ...
                                lblNumProd2.Location = new Point(posCtrl + 52, lblNumProd2.Location.Y);
                    ...
                    {
                        MessageBox.Show("Debe ingresar el polo para poder continuar", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        chkVistaPrevia.Checked = false;
                        break;
                    }
                    ...
                    if (ftbxPol2.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd2.Location = new Point(posCtrl + 50, lblDenProd2.Location.Y);
                    ...
                    if (i == 0)
                    {
                        ...
                        {
                            //Este es un error que aparece cuando no se completa con ningún valor
