                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    if (rbRe.Checked) //ceros reales
                    {
                        ...
                        if (ftbxCer1.Text != "")
                        {
                            ...
                            else if ((i == 1) && (permitir))
                            {
                                ...
                                lblNumProd2.Location = new Point(posCtrl + 46, lblNumProd2.Location.Y);
                        ...
                        if (ftbxCer2.Text != "")
                        {
                            ...
                            else if ((i == 1) && (permitir))
                            {
                                ...
                                lblNumProd3.Location = new Point(posCtrl + 46, lblNumProd3.Location.Y);
                    ...
                    else //ceros imaginarios
                    {
                        if (ftbxCeroIm.Text != "")
                        {
                            ...
                            else
                            {
                                ...
                                lblNumComReal1.Location = new Point(posCtrl + 48, lblNumComReal1.Location.Y);
                                ...
                                lblNumComIm1.Location = new Point(posCtrl + 104, lblNumComIm1.Location.Y);
                                lblNumComIm2.Visible = true;
                                lblNumComIm2.Location = new Point(posCtrl + 271, lblNumComIm2.Location.Y);
                    ...
                    if (ftbxPol3.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd3.Location = new Point(posCtrl + 46, lblDenProd3.Location.Y);
                    ...
                    if (ftbxPol4.Text != "")
                    {
                        ...
                        else if ((i == 1) && (permitir))
                        {
                            ...
                            lblDenProd4.Location = new Point(posCtrl + 46, lblDenProd4.Location.Y);
